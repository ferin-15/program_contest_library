...
# :warning: 並行二分探索 <small>(oldcode/parallel_binary_search.cpp)</small>

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#bf50ccff88ac9b2562bee63cf804278c">oldcode</a>
* <a href="{{ site.github.repository_url }}/blob/master/oldcode/parallel_binary_search.cpp">View this file on GitHub</a>
    - Last commit date: 2019-10-03 22:20:29+09:00


* 並行二分探索
* 並列二分探索を実行 O((M+Q)*logM)
...
{% raw %}
```cpp
#line 1 "oldcode/parallel_binary_search.cpp"
/**
* @file parallel_binary_search.cpp
* @brief 並行二分探索
* @detail https://agc002.contest.atcoder.jp/tasks/agc002_d でverify
